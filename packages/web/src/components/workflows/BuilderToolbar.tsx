...
export interface BuilderToolbarProps {
  ...
  provider: 'claude' | 'codex' | 'vercel-ai' | undefined;
  ...
  onProviderChange: (p: 'claude' | 'codex' | 'vercel-ai' | undefined) => void;
      ...
      <div className="flex items-center h-12 px-3 border-b border-border gap-2">
        ...
        <div className="flex items-center gap-1.5 mx-auto">
          <select
            ...
            onChange={(e): void => {
              onProviderChange(
                (e.target.value || undefined) as 'claude' | 'codex' | 'vercel-ai' | undefined
              );
            }}
